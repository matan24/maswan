...
@section('container')
       ...
       <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h5><b class="font-weight-bold">UPDATE STAFF PT MUSTIKA AGRO SARI</b></h5>
          <br>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <form action="{{ route('admin.input1.masedit-staff.update_staff_mas', $mas->id ) }}" method="post" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    <br>
                    @if (session('status'))
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            ...
                            value="{{ $mas->gender }}" class="form-control">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            ...
                            value="{{ $mas->status_karyawan}}" class="form-control">
                                <option selected disabled>Pilih</option>
                                <option>
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-8">
                          ...
                          value="{{ $mas->pendidikan }}" class="form-control">
                              <option selected disabled>Pilih</option>
                              <option>
                                SD
                              </option>
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-8">
                          ...
                          value="{{ $mas->agama }}" class="form-control">
                              <option selected disabled>Pilih</option>
                              <option>
                                Islam
                              </option>
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-8">
                          ...
                          value="{{ $mas->status_pernikahan}}" class="form-control">
                              <option selected disabled>Pilih</option>
                              <option>
                                Single | TK0 TK1
                              </option>
