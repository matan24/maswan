...
@section('title', 'Karyawan | PT Mustika Agro Sari')
      ...
      <!-- Image and text -->
        <nav class="navbar navbar-light bg-light">
          <a class="navbar-brand" href="#">
            ...
            <b>DATA KELOLA KARYAWAN STAFF & NON STAFF PT MUSTIKA AGRO SARI</b>
          </a>
        </nav>
        <hr class="my-4">
        ...
        <!-- Page Heading -->
        {{-- <p class="mb-4"><b>Pastikan untuk selalu mengupdate data karyawan..!</b></p> --}}
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <div class="alert alert-info">
                 ...
                 @endif
                <br>
                <a href="{{ route('admin.input1.mascreate') }}" class="btn btn-outline-info btn-lg"><i class="bi bi-person-fill-add"></i>  ADD STAFF</a>
                <a href="{{ route('admin.input2.mascreate-non-staff') }}" class="btn btn-outline-success btn-lg"><i class="bi bi-person-fill-add"></i>  ADD NON STAFF</a>  
                <a href="{{ route('admin.input1.show-staff') }}" class="btn btn-outline-info btn-lg"><i class="bi bi-filetype-doc"></i> SHOW DATA STAFF</a>
                <a href="{{ route('admin.input2.showmas-non-staff') }}" class="btn btn-outline-success btn-lg"><i class="bi bi-filetype-doc"></i> SHOW DATA NON STAFF</a>      
                <br><br><br>
              </div>
        </div>
