...
@section('title', 'Show Data Staff | PT Mustika Agro Sari')
     ...
     <div class="container-fluid">
       ...
       <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand" href="#">
          ...
          <b>DATA KELOLA KARYAWAN STAFF PT MUSTIKA AGRO SARI</b>
        </a>
      </nav>
      <hr class="my-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <div class="alert alert-info">
                 ...
                 @endif
                 <br>
                 <a href="{{ route('admin.input1.mascreate') }}" class="btn btn-info">Kembali</a>    
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ Storage::url($item->cv) }}"> <img src="{{ asset('admin2/img/folder.png') }}" width="60" height="60" class="rounded-circle" alt=""></a></td>
                          <td class="">
                              <a href="{{ route('admin.input1.masedit-staff', Crypt::encryptString($item->id)) }}" class="btn btn-warning btn-lg mb-2"><i class="bi bi-pencil-fill"></i></a> 
            
                              <form action="{{ route('admin.input1.show-staff.delete', $item->id) }}" method="post">
                                @method('delete')
                                @csrf 
