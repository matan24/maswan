...
@section('title', 'Input Karyawan Non Staff Mustika Agro Sari')
...
@section('container')
       ...
       <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h5><b class="font-weight-bold">ADD NON STAFF PT MUSTIKA AGRO SARI</b></h5>
          <br>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <form action="{{ route('admin.input2.mascreate-non-staff.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <br>
                    @if (session('status'))
