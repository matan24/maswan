...
@section('title', 'Input Karyawan Staff | PT Wanasari Nusantara')
...
@section('container')
       ...
       <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h5><b class="font-weight-bold">ADD STAFF PT WANASARI NUSANTARA</b></h5>
          <br>

        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                <a href="{{ route('admin.input3.wankaryawan') }}" class="btn btn-info">Kembali</a>

                <form action="{{ route('admin.input3.wancreate-staff.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <br>
                    @if (session('status'))
