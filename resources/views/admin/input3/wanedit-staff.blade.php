...
@section('title', 'Update Karyawan Staff| PT Wanasari Nusantara')
...
@section('container')
       ...
       <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h5><b class="font-weight-bold">UPDATE STAFF PT WANASARI NUSANTARA</b></h5>
          <br>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <form action="{{ route('admin.input3.wanedit-staff.update_wan_staff', $wan->id ) }}" method="post" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    <br>
                    @if (session('status'))
                    ...
                    <div class="mb-3 row">
                      <label for="nik_ws" class="col-sm-2 col-form-label">Nik Karyawan</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nik_ws" id="nik_ws"
                        value="{{ $wan->nik_ws }}">
                      </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-8">
                          ...
                          value="{{ $wan->gender }}" class="form-control">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-sm-8">
                          ...
                          value="{{ $wan->status_karyawan}}" class="form-control">
                              <option selected disabled>Pilih</option>
                              <option>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        ...
                        value="{{ $wan->pendidikan }}" class="form-control">
                            <option selected disabled>Pilih</option>
                            <option>
                              SD
                            </option>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        ...
                        value="{{ $wan->agama }}" class="form-control">
                            <option selected disabled>Pilih</option>
                            <option>
                              Islam
                            </option>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        ...
                        value="{{ $wan->status_pernikahan}}" class="form-control">
                            <option selected disabled>Pilih</option>
                            <option>
                              Single | TK0 TK1
                            </option>
