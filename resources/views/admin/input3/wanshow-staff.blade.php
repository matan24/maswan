...
@section('title', 'Show Karyawan Staff | PT Wanasari Nusantara')
     ...
     <div class="container-fluid">
           ...
           <nav class="navbar navbar-light bg-light">
            <a class="navbar-brand" href="#">
              ...
              <b>DATA KELOLA KARYAWAN STAFF PT WANASARI NUSANTARA</b>
            </a>
          </nav>
          <hr class="my-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <div class="alert alert-info">
                 ...
                 @endif
                <br>
                <a href="{{ route('admin.input3.wancreate-staff') }}" class="btn btn-info">Kembali</a>      
                <br><br><br>
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td><a href="{{ Storage::url($item->cv) }}"> <img src="{{ asset('admin2/img/folder.png') }}" width="60" height="60" class="rounded-circle" alt=""></a></td>
                                <td class="">
                                    <a href="{{ route('admin.input3.wanedit-staff',Crypt::encryptString($item->id)) }}" class="btn btn-warning btn-lg mb-2"><i class="bi bi-pencil-fill"></i></a> 
                  
                                    <form action="{{ route('admin.input3.wanshow-staff.delete', $item->id )}}" method="post">
                                      @method('delete')
                                      @csrf 
