...
@section('title', 'Input Karyawan Non Staff | PT Wanasari Nusantara')
...
@section('container')
       ...
       <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h5><b class="font-weight-bold">ADD NON STAFF PT WANASARI NUSANTARA</b></h5>
          <br>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-4">
                ...
                <form action="{{ route('admin.input4.wancreate-non-staff.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <br>
                    @if (session('status'))
